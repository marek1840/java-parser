...
import com.enkidu.lignum.parsers.ast.statement.declarator.{FunctionDeclarator, MethodDeclarator}
import com.enkidu.lignum.parsers.ast.statement.modifers.Modifier

case class InterfaceMethodDeclaration(annotations: Seq[Annotation], modifier: Seq[Modifier],
